...
## For this project I'll be making a dashboard in Tableau visualising the data, and R (programming language) to correlate country (x1), number of international games played (x2), birth year (x3) and Elo (y).
