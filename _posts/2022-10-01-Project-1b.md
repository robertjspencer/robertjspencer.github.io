...
All correlations < ±0.8. So whilst there might be moderate multicollinearity present (non-issue) due to the strong correlation (R-value = -0.73) between income inequality and Education attainment at 'High school diploma or higher', severe multicollinearity isn't (potential issue).
