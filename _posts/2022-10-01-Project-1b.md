...
Checking for multicollinearity, I calculated the correlation between every independent variable (as well as the dependent variable):
![image](https://user-images.githubusercontent.com/105367716/173409262-346e18dc-aa2a-48d7-9369-d8e1a8a5324a.png)

We can see that there's a weak-moderate positive correlation between income inequality (Gini coefficient) and population density with an R-value = 0.36, this is fine.
The correlation between population density and obtaining a highschool diploma or higher is negligible (R-value = -0.07), this is also fine.

However, there's a strong inverse correlation between income inequality and having obtained a high school diploma or higher with an R-value =-0.72. 
