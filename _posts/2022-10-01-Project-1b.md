...
### Question 4 answer - Can any appropriately relevant aforementioned indepedent variables combined explain a state's death:population ratio?
...
R-value = ±0.31. This is a weak correlation. Adjusted R-squared = 0.06, meaning that 6% of the variance of Y is explained by X1 and X3. 
