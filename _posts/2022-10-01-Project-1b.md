...
Respectively their R-value's are: -0.23, 0.0025 and 0.07. The last two's R-value is too small to show any sort of correlation. The first R-value, -0.23, shows a weak inverse correlation between state's educational attainment being 'High school diploma or higher' and death:population ratio.
