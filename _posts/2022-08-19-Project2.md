...
At a glance this data set looks nearly perfect. However it could use a tad more cleaning. Lets change 'birth_year' to 'age' to simplify things, rename 'ELO' to 'Elo' and 'games' to 'games_played', and drop the title column as every player is a grandmaster (GM) and the now redundant birth_year column.
...
Voila! Based off this plot, younger players within the top 200 tend to perform slightly better on average. 

Overall this has been a fun quick project. [*Here*](https://github.com/robertjspencer/robertjspencer.github.io/files/9382926/Project2Workings.txt) is a .txt file with my workings in R if you're interested. Thanks for reading!
