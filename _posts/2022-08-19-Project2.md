...
At a glance this data set looks nearly perfect. However it could use a tad more cleaning. Lets change 'birth_year' to 'age' to simplify things, rename 'ELO' to 'Elo' and 'games' to 'games_played', and drop the title column as player is a grandmaster (GM) and the now redundant birth_year column.
