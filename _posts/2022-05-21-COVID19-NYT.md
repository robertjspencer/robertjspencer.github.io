...
Quite frankly this wasn't what I expected my results to look like and it seems like some of the data provided by NYT in the us-counties-2022.csv file is wrong. For instance [Nevada definitely hasn't had 8481 deaths this year](https://covid.cdc.gov/covid-data-tracker/#trends_totaldeaths)
