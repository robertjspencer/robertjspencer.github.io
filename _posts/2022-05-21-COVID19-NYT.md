...
Quite frankly this wasn't what I expected my results to look like and it seems like some of the data provided by NYT in the us-counties-2022.csv file is inaccurate. For instance [Nevada has only had 2584 deaths this year according to the CDC](https://covid.cdc.gov/covid-data-tracker/#trends_totaldeaths).
