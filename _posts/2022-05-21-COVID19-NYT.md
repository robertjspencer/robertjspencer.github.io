...
Quite frankly this wasn't what I expected my results to look like and it seems like some of the data provided by NYT in the us-counties-2022.csv file is inaccurate, or perhaps it isn't. For example [Nevada has only had 2584 deaths from 01/01/2022-19-01-2022 according to the CDC](https://covid.cdc.gov/covid-data-tracker/#trends_totaldeaths) which conflicts with the 8481 deaths seen above in my query.
