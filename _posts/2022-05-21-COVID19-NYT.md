...
5. What are the top 10 states by cases:population ratio so far this year and is their governer a Democrat or Republican? (Join, make CSV file named state_info including state,population,governer,political_party)
