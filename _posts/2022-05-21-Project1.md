...
For my first project using SQL I decided to look at publicly available COVID-19 data. [__*Here*__](https://github.com/nytimes/covid-19-data) is a link to the public dataset I used, provided by The New York Times (NYT).
