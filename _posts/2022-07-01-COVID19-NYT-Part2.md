...
1. Does a states' population density correlate with its deaths:population ratio?
2. Does a states' education level correlate with its deaths:population ratio?
3. Does a states' income inequality correlate with its deaths deaths:population ratio?
