...
1. Does population density correlate with a states deaths:population ratio?
2. Does education level correlate with a states deaths:population ratio?
3. Does income inequality correlate with a states deaths deaths:population ratio?
